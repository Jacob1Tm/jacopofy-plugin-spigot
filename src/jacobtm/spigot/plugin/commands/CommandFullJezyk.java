...
public class CommandFullJezyk implements CommandExecutor {
    @Override
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            player.sendMessage(ChatColor.YELLOW + "[Intro]\n" + ChatColor.GREEN +
                    ...
                    "A czy wiecie, że kolce jeża to tak naprawdę przekształcone włosy? Po urodzeniu ma ich około st...\n" +
                    "47\n" +
                    "\n" + ChatColor.YELLOW +
                    "[Zwrotka 1]\n" + ChatColor.GREEN +
                    ...
                    "W sensie pierwszy, jaki będę miał (yeah!, yeah!)\n" +
